...
def allometric_dict(mm,dbh):
    #global biomass
    mf = "D:\\MEGA\\Live_cases\\Hybrid\\Global_Synthesis\\ITRDB\\" \
    "rwl_metadata_2020_4_18_all_nontrw_non_species_removed_to_shp.csv"

    #print(os.getcwd())
         #"ITRDB_global_2020_7_5_s1982_multiple_sites_sub.csv"
