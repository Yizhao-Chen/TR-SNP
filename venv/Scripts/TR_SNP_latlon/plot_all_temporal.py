...
#add lat_in lon_in here for global synthesis 2019/12/22
def plot_all(fk,lat_in,lon_in):
    ...
    pdf_input.to_csv(path_or_buf="output_tr.csv", sep=',', na_rep="-999")
    bai_sum.to_csv(path_or_buf="output_bai_sum.csv", sep=',', na_rep="-999")
    pdf_mean.to_csv(path_or_buf="output_tr_mean.csv", sep=',', na_rep="-999")
