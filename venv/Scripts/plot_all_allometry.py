...
def plot_allometry(fk):
    ...
    with localconverter(rpy2.robjects.default_converter + pandas2ri.converter):
        ...
        name_diaa = mm + "_dia_bias_corr.csv"
        name_diaa_mean = mm + "_dia_mean_bias_corr.csv"
        name_bioo = mm + "_bio_bias_corr.csv"
        name_bioo_mean = mm + "_bio_mean_bias_corr.csv"

        name_delta_diaa = mm + "_delta_dia_bias_corr.csv"
        name_delta_diaa_mean = mm + "_delta_dia_mean_bias_corr.csv"
        name_delta_bioo = mm + "_delta_bio_bias_corr.csv"
        name_delta_bioo_mean = mm + "_delta_bio_mean_bias_corr.csv"
        ...
        #pdf_diaa.to_csv(name_diaa, sep=',', na_rep="-999")
        pdf_diaa_mean.to_csv(name_diaa_mean, sep=',', na_rep="-999")
        #pdf_bioo.to_csv(name_bioo, sep=',', na_rep="-999")
        pdf_bioo_mean.to_csv(name_bioo_mean, sep=',', na_rep="-999")

        #pdf_delta_diaa.to_csv(name_delta_diaa, sep=',', na_rep="-999")
        pdf_delta_diaa_mean.to_csv(name_delta_diaa_mean, sep=',', na_rep="-999")
        #pdf_delta_bioo.to_csv(name_delta_bioo, sep=',', na_rep="-999")
        pdf_delta_bioo_mean.to_csv(name_delta_bioo_mean, sep=',', na_rep="-999")
    ...
    for i in range(1, len(fk)):
        ...
        with localconverter(rpy2.robjects.default_converter + pandas2ri.converter):
            ...
            name_dia2 = mm + "_dia_bias_corr.csv"
            name_dia_mean2 = mm + "_dia_mean_bias_corr.csv"
            name_bio2 = mm + "_bio_bias_corr.csv"
            name_bio_mean2 = mm + "_bio_mean_bias_corr.csv"

            name_delta_dia2 = mm + "_delta_dia_bias_corr.csv"
            name_delta_dia_mean2 = mm + "_delta_dia_mean_bias_corr.csv"
            name_delta_bio2 = mm + "_delta_bio_bias_corr.csv"
            name_delta_bio_mean2 = mm + "_delta_bio_mean_bias_corr.csv"
